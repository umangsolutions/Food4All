...
import com.example.food4all.activities.volunteer.ResetPasswordActivity;
...
public class DonorLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAppPrefsManager = new MyAppPrefsManager(DonorLoginActivity.this);
        ConstantValues.internetCheck(DonorLoginActivity.this);
        ...
        if (!connected) {
            Toast.makeText(DonorLoginActivity.this, "Network Unavailable", Toast.LENGTH_SHORT).show();
        }
        ...
        findViewById(R.id.register).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DonorLoginActivity.this, DonorRegistrationActivity.class);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DonorLoginActivity.this, ResetPasswordActivity.class);
                i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                //i.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(i);
            }
    ...
    private void userLogin() {
        ...
        if (s1.equals("admin@gmail.com") && s2.equals("Admin@123")) {
            Intent i = new Intent(DonorLoginActivity.this, AdminActivity.class);
            i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(i);
            finish();
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (!task.isSuccessful()) {
                                ...
                                progressDialog.dismiss();
                                Toast.makeText(DonorLoginActivity.this, "Please Enter Valid Email/Password", Toast.LENGTH_SHORT).show();
                                ...
                                Intent intent = new Intent(DonorLoginActivity.this, DonorActivity.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                startActivity(intent);
                                finish();
                                Toast.makeText(DonorLoginActivity.this, "Success", Toast.LENGTH_SHORT).show();
                                progressDialog.dismiss();
