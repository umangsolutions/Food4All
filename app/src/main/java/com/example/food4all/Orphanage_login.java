...
public class Orphanage_login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Orphanage_login.this,OrphangeRegistration.class);
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (dataSnapshot.exists()) {
                                ...
                                for (DataSnapshot issue : dataSnapshot.getChildren()) {
                                    ...
                                    dbpass=issue.getValue(Orphanage_Modal.class).getPassword();
                                }
                                if(pw.equals(dbpass)) {
                                    Toast.makeText(Orphanage_login.this, "Login Successful", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(Orphanage_login.this,OrphangeActivity.class);
                                    startActivity(intent);
                                }
                                else {
                                    Toast.makeText(Orphanage_login.this, "login Failed !", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
