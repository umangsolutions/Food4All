...
public class OrphangeRegistration extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(OrphangeRegistration.this,Orphanage_login.class);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nam.isEmpty()) {
                    ...
                    Toast.makeText(OrphangeRegistration.this, "Please choose Type !", Toast.LENGTH_SHORT).show();
                    ...
                    final ProgressDialog progressDialog = new ProgressDialog(OrphangeRegistration.this);
                    progressDialog.setMessage("Registering...");
                    progressDialog.show();

                    databaseReference = FirebaseDatabase.getInstance().getReference().child("Organization_Details").child(id);
                    Orphanage_Modal orphanage_modal = new Orphanage_Modal(nam,orgtype,usnam,pw,ph,add);
                    databaseReference.setValue(orphanage_modal).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            progressDialog.dismiss();
                            Toast.makeText(OrphangeRegistration.this, "Registered Successfully !", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(OrphangeRegistration.this,Orphanage_login.class);
                            startActivity(intent);
                        }
                    });
